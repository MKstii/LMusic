...
namespace LMusic.Additional
{
    public class DatabaseData
    {
        ...
        {
            //дефолтные
            new Picture(1, "/pictures/Avatar", "avatarDefault.jpg", PictureType.Avatar, true),
            new Picture(2, "/pictures/Music", "musicDefault.png", PictureType.Music, true),
            new Picture(3, "/pictures/Playlist", "playlistDefault.png", PictureType.Playlist, true),

            //аватарки
            new Picture(4, "/pictures/Avatar/213939128", "JJgF7k7Znbw.jpg", PictureType.Avatar, false), //миша
            new Picture(5, "/pictures/Avatar/916209678", "nTe9Z-ssd_c.jpg", PictureType.Avatar, false), //валя
           // new Picture(6, "/pictures/Avatar/213939128/avatarDefault.jpg", PictureType.Avatar, false), //маша

            //Музыка
            new Picture(7, "/pictures/Music/213939128", "e2be07c304a7472ca440a73b11a78cb7_464_464.jpg", PictureType.Music, false), //ANNA ASTI - Царица.mp3
            new Picture(8, "/pictures/Music/213939128", "cb18c81a2dad1f8cc623968bb0fe05c812_resize_2000x2000_same_d504fb.png", PictureType.Music, false), //МакSим - Знаешь ли ты.mp3
            new Picture(9, "/pictures/Music/213939128", "nervy_nervy.280.jpg", PictureType.Music, false), //Нервы - Нервы.mp3
        };
